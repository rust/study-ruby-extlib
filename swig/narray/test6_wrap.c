...
SWIGINTERN VALUE
_wrap_mul_all(int argc, VALUE *argv, VALUE self) {
  float *arg1 = (float *) 0 ;
  int arg2 ;
  float result;
  VALUE vresult = Qnil;
  ...
  }
  {
    ...
    na = na_cast_object(argv[0], NA_SFLOAT);
    GetNArray(na, n_na);
    arg1 = (float*)n_na->ptr;
    arg2 = n_na->total;
  }
  result = (float)mul_all(arg1,arg2);
...
SWIGEXPORT void Init_test(void) {
  ...
  rb_define_module_function(mTest, "mul_all", _wrap_mul_all, -1);
}
